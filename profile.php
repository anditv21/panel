         ...
         <div class="card">
            <div class="card-body">
               ...
               <center>
                  ...
                  <?php else: ?>
                  <a href=<?php Util::display(SITE_URL.SUB_DIR. "/viewprofile.php?uid=$uid") ?>><img width="120" height="120" class="rounded-circle img-profile" src="<?php echo Util::getavatar($uid); ?>" style="border-color: rgb(255,255,255)!important;"></a>
                  <?php endif; ?>
               </center>
            </div>
         </div>
