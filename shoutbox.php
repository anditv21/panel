...
foreach ($msgarray as $row) {
  ...
  if ($avatar) {
    Util::display(
      "<a href='$url' target='_blank'><img width='45' height='45' class='rounded-circle img-profile' src='$avatar''></a> "
    );
  } else {
    Util::display(
      "<a href='$url' target='_blank'><img width='45' height='45' class='rounded-circle img-profile' src='assets/img/avatars/Portrait_Placeholder.png' '></a> "
    );
  }
  Util::display("<strong style='color: white;'>$row->user</strong>");
